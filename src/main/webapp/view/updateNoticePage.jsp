...
<div class="col-md-3 core">
    ...
    <form action="/updateNotice" method="post">
        ...
        <div class="form-group">
            ...
            <input type="text" value="${notice.content}" class="form-control" required="required" placeholder="请输入公告内容" id="content" name="content">
        </div>
        <div>
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" required="required" placeholder="请输入发布者" id="publisher" name="publisher" value="${notice.publisher}">
        </div>
        <br>
