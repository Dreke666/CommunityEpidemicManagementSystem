...
<div class="col-md-3 core">
    <h3 align="center">添加疫情信息</h3>
    <form action="/addOutbreak" method="post">
        <div class="form-group">
            <label for="localtion" class="control-label">地区</label>
            <input type="text" class="form-control" required="required" placeholder="地区" id="localtion" name="localtion">
        </div>

        <div class="form-group">
            <label for="risklevel" class="control-label">风险等级</label>
            <input type="text" class="form-control" required="required" placeholder="请输入等级" id="risklevel" name="risklevel">
        </div>
        <div class="form-group">
            <label for="content" class="control-label">疫情内容</label>
            <input type="text" class="form-control" required="required" placeholder="疫情内容" id="content" name="content">
        </div>
