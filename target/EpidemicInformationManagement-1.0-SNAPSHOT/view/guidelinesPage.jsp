...
<div class="col-md-3 core">
    ...
    <form action="/updateGuideLines" method="post">

        <div class="form-group">
            <label for="content" class="control-label">内容</label>
            <textarea type="text" value="${guidelines.content}" class="form-control" required="required" placeholder="请输入内容" id="content" name="content"></textarea>
        </div>
